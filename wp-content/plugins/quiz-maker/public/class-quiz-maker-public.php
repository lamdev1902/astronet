...
class Quiz_Maker_Public {
    ...
    /*******************************************************************************************************/
        ...
        if(array_key_exists('hide_score', $options) && $options['hide_score'] != "on"){
            $show_score_html = "<p class='ays_score ays_score_display_none animated'>" . __( 'YOUR TOTAL SCORE: ', $this->plugin_name ) . "</p>";
        }
    ...
    /*******************************************************************************************************/
        ...
        $text_title = do_shortcode(stripslashes($quiz['title']));;
        $ays_title_text = "<div class='ays_title-text'>
        <p class='text-result'>Your Result</p>
        <p class='text-title'>$text_title</p>
        </div>";
 
        $logo = get_field('logo','option');
        $ays_title_img = "<div class='ays_title-img'>
            <img src='$logo'>
        </div>";

        $ays_title = "<div class='ays_title'>"
        .$ays_title_text.
        $ays_title_img.
        "</div>";

        $ays_quiz_results_page_content = $ays_title. 
            $pass_score_html .
            $show_score_html .
    ...
    /*******************************************************************************************************/
        ...
        $quiz_styles .= "
            ...
            #ays-quiz-container-" . $id . " #ays_finish_quiz_" . $id . " .ays-field {
                margin-bottom: " . ($answers_margin / 3) . "px;
                position: relative;
            }
                ...
                if ($last) {
                    ...
                    switch($options['informationForm']){
                        case "disable":
                            ...
                            $input = "<i class='" . $buttons['nextButton'] . " ays_fa ays_fa_flag_checkered ays_finish action-button ays_arrow ays_next_arrow ".$class_for_keyboard."'></i><input type='submit' name='ays_finish_quiz' class='ays_next ays_finish  action-button ".$class_for_keyboard."' value='" . $settings_buttons_texts['seeResultButton'] . "'/>";
                            break;
                        case "before":
                            $input = "<i class='" . $buttons['nextArrow'] . " ays_fa ays_fa_flag_checkered ays_finish action-button ays_arrow ays_next_arrow ".$class_for_keyboard."'></i><input type='submit' name='ays_finish_quiz' class=' " . $buttons['nextButton'] . " ays_next ays_finish  action-button ".$class_for_keyboard."' value='" . $settings_buttons_texts['seeResultButton'] . "'/>";
                            break;
