...
//                    }
            ...
            if(response.displayScore == 'by_points') {
                form.find('p.ays_score').html(form.find('p.ays_score').text()+'<span class="ays_score_percent animated"> ' + quizScore[0] + " out of " + quizScore[1] + '</span>');
            }else {
        ...
        form.css({'display':'flex', 'flex-direction':'column-reverse'})
