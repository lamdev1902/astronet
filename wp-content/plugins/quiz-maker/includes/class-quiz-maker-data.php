    ...
    */
                ...
                if (($is_percent && intval( $cat[$key] >= 0)) || (!$is_percent && !empty($val) && $val[1] > 0)) {
                    ...
                    $result .= '<div class="ays_message_vars_multiple_bar">
                                    ...
                                    <div class="ays_message_vars_multiple_progress_bar">
                                        <div class="ays_message_vars_multiple_progress_bar_filled" style="width:'. $width .'%;background-color:'. $text_color .'">
        ...
        if (isset($value) && isset($whole) && intval($whole) > 0) {
            ...
            $result = '<div class="ays_message_vars_simple_bar">
                            <div class="ays_message_vars_simple_bar_progress_bar">
                                <div class="ays_message_vars_simple_bar_progress_bar_filled" style="width:'. $width .'%;background-color:'. $text_color .'">
    ...
    public static function ays_get_user_pass_time_bar_chart ($quiz_styles, $start, $end, $timer) {
        ...
        $result = '<div class="ays_message_vars_multiple_bar">
                        ...
                        <div class="ays_message_vars_multiple_progress_bar">
                            <div class="ays_message_vars_multiple_progress_bar_filled" style="width:'. $width .'%;background-color:'. $text_color .'"></div>
                        </div>
                    </div>
                ...
                $result .= '<div class="ays_detailed_result_column_chart_column">
                                ...
                                <div class="ays_detailed_result_column_chart_column_row">
                                    <div class="ays_detailed_result_column_chart_column_empty">
                                        <div class="ays_detailed_result_column_chart_column_filled" style="height:'. $height .'%;background-color:'. $text_color .';line-height:'. $quiz_styles['answers_font_size'] .'px">
    ...
    public static function ays_get_user_corrects_count_pie_chart ($quiz_styles, $questions_count, $detailed_data) {    
        ...
        if ($questions_count > 0 && count($detailed_data) == 3) {
            ...
            $sect_1 = round(($detailed_data[0] / $questions_count), 2) * 100;
            $sect_2 = round(($detailed_data[1] / $questions_count), 2) * 100;
            $sect_3 = round(($detailed_data[2] / $questions_count), 2) * 100;
            ...
            $result  = '<div class="ays_user_corrects_count_pie_chart_container">
                    ...
                    if ($sect_1 > 0) {
                        $result .= '<div>
                                        <span class="ays_user_corrects_count_pie_chart_labels_rect">
                                            <span style="background:'. self::hex2rgba($text_color) .'"></span>
                                        </span>
                    ...
                    if ($sect_2 > 0) {
                        $result .= '<div>
                                        <span class="ays_user_corrects_count_pie_chart_labels_rect">
                                            <span style="background:'. self::hex2rgba($text_color, 0.79) .'"></span>
                                        </span>
                    ...
                    if ($sect_3 > 0) {
                        $result .= '<div>
                                        <span class="ays_user_corrects_count_pie_chart_labels_rect">
                                            <span style="background:'. self::hex2rgba($text_color, 0.46) .'"></span>
                                        </span>
            ...
            $result .= '<style>
                            .ays_user_corrects_count_pie_chart {
                                ...
                                background: repeating-conic-gradient(
                                    from 0deg,
                                    '. self::hex2rgba($text_color) .' 0deg calc(3.6deg * '. $sect_1 .'),
                                    '. self::hex2rgba($text_color, 0.79) .' calc(3.6deg * '. $sect_1 .') calc(3.6deg * '. ($sect_2 + $sect_1) .'),
                                    '. self::hex2rgba($text_color, 0.46) .' calc(3.6deg * '. ($sect_2 + $sect_1) .') calc(3.6deg * 100)
                                );
                            }
